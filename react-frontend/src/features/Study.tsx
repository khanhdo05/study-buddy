...
function reply(text: string, hints: boolean) {
  if (/homework|assignment|problem \d|give me.*answer/i.test(text) && hints) return 'Your instructor has enabled guided help for assigned work. Tell me what you’ve tried and where you got stuck. We can work through the next step together.';
